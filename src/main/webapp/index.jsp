	...
	<div id="carouselExampleCaptions" class="carousel slide"
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img src="images/bottiglie-vino.jpg" class="d-block w-100"
					width="14%">
				<div class="carousel-caption d-none d-md-block">
					<h5>INGREDIENTE MAGICO: IL TEMPO</h5>
					<p>L'invecchiamento consente ai vari prodotti di offrire un
						autentico risveglio al momento della scoperta</p>
				</div>
			</div>
			<div class="carousel-item">
				...
				<div class="carousel-caption d-none d-md-block">
					...
					<p>Ogni momento è propizio per degustare e scoprire nuovi
						sapori</p>
				</div>
			</div>
		</div>
